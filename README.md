...
standard. However, it is faster than GCC's and Clang's implementations. In fact, its speed should be comparable to that
of C. S. Larsen's implementation (which is … extremely fast:sweat_smile:).
