...
#define mt19937_seed(seed, ...) mt19937_seed(seed, GET_OR_NULL(__VA_ARGS__ __VA_OPT__(,) NULL))
#define mt19937_64_seed(seed, ...) mt19937_64_seed(seed, GET_OR_NULL(__VA_ARGS__ __VA_OPT__(,) NULL))
#define mt19937_rand(...) mt19937_rand(GET_OR_NULL(__VA_ARGS__ __VA_OPT__(,) NULL))
#define mt19937_64_rand(...) mt19937_64_rand(GET_OR_NULL(__VA_ARGS__ __VA_OPT__(,) NULL))
#define mt19937_rand_integer(modulus, ...) mt19937_rand_integer(modulus, GET_OR_NULL(__VA_ARGS__ __VA_OPT__(,) NULL))
#define mt19937_64_rand_integer(modulus, ...) mt19937_64_rand_integer(modulus, GET_OR_NULL(__VA_ARGS__ __VA_OPT__(,) NULL))
#define mt19937_rand_real(...) mt19937_rand_real(GET_OR_NULL(__VA_ARGS__ __VA_OPT__(,) NULL))
#define mt19937_64_rand_real(...) mt19937_64_rand_real(GET_OR_NULL(__VA_ARGS__ __VA_OPT__(,) NULL))
#define mt19937_rand_shuffle(items, num_of_items, size_of_item, ...) mt19937_rand_shuffle(items, num_of_items, size_of_item, GET_OR_NULL(__VA_ARGS__ __VA_OPT__(,) NULL))
